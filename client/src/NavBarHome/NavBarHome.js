    ...
    return(
        <div className={url ? styles.homeNav : styles.navBar}>
            ...
            <div className={ styles.logo}>
                <span>Jaroslav Merta</span>
                {/* <span>Vždy měj po ruce nepopsaný list, aby ses mohl naučit něco nového <br/> a lehce zahodit ten nečitelný a nepotřebný</span> */}
            </div>}

            <nav >
                <ul className={styles.wordNav}>
                    <li>
                    <svg xmlns="http://www.w3.org/2000/svg" enableBackground="new 0 0 24 24" height="24px" viewBox="0 0 24 24" width="24px" fill="#000000"><rect fill="none" height="24" width="24"/><path d="M22,11V3h-7v3H9V3H2v8h7V8h2v10h4v3h7v-8h-7v3h-2V8h2v3H22z M7,9H4V5h3V9z M17,15h3v4h-3V15z M17,5h3v4h-3V5z"/></svg>
                        <Link to={"/programmer"} className="">
                            Programátor
                        </Link>
                    </li>
                    <li>
